_base_ = './pkd-neck_yolov8-n-fuser_yolov8-n-shufflenet-neck_4xb32_500e_coco-50.py'

work_dir = './work_dirs/coco/{{fileBasenameNoExtension}}/'
_base_.visualizer.vis_backends[-1].init_kwargs=dict(project='research_coco', name='pkd_yolov8-n-fuser-bb-neck_yolov8-n-shufflenet-neck_mr')
