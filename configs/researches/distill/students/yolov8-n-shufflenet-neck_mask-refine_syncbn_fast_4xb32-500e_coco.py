_base_ = './yolov8-n-shufflenet-neck_syncbn_fast_4xb32-500e_coco.py'

work_dir = './work_dirs/coco/{{fileBasenameNoExtension}}/'
_base_.visualizer.vis_backends[-1].init_kwargs=dict(project='research_coco', name='yolov8_n_shufflenet-neck_mr')
