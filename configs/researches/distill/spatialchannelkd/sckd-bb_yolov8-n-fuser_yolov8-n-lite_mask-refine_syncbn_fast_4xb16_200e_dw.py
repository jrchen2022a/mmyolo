...
model = dict(
    distiller=dict(
        distill_losses=dict(
            loss_s2=dict(type='SpatialChannelWiseDivergence', tau=1, loss_weight=10),
            loss_s3=dict(type='SpatialChannelWiseDivergence', tau=1, loss_weight=10),
            loss_s4=dict(type='SpatialChannelWiseDivergence', tau=1, loss_weight=10))))
